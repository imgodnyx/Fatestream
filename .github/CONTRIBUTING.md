# Contributing Guidelines for Fatestream
...
- [Contributing Guidelines for Fatestream](#contributing-guidelines-for-afterstream)
  - [Contents](#contents)
...
To make a GitHub issue for Fatestream, please visit the [new issue page](https://github.com/thingfoil/afterstream/issues/new/choose) where you can pick either the "Bug Report" or "Feature Request" template.
...
GitHub issues are how we track our bugs and feature requests that will be implemented into Fatestream - all contributions **must** have an issue and be approved by a maintainer before a pull request can be worked on.
...
If you're here because you'd like to work on an issue, amazing! Thank you for even considering contributing to Fatestream; it means a lot :heart:
...
Our recommended development environment to work on Fatestream is:
...
- Keep as much as possible to the style of Fatestream. Look around our codebase to familiarise yourself with how we do things!
...
Language contributions help Fatestream massively, allowing people worldwide to use our app!
